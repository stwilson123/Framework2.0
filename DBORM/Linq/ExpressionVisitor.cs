...
namespace DBORM
{
    ...
    internal class ExpressionVisitor
	{
		...
		protected virtual Expression Visit(Expression expression,object member = default(object))
		{
			if(expression == null)
				return null;
			...
			switch(expression.NodeType)
			{
				...
				case ExpressionType.TypeAs:
					return this.VisitUnary((UnaryExpression)expression,member);
				...
				case ExpressionType.Call:
                    return this.VisitMethodCall((MethodCallExpression)expression, member);
				case ExpressionType.Constant:
					return this.VisitConstant((ConstantExpression)expression);
				case ExpressionType.MemberAccess:
                    return this.VisitMemberAccess((MemberExpression)expression, member);
		...
		/// <param name="expression">表达式</param>
		/// <returns>表达式</returns>
        protected virtual Expression VisitMemberAccess(MemberExpression expression, object memberValue = default(object))
		{
			return expression;
		}
		...
		/// <param name="expression">表达式</param>
		/// <returns>表达式</returns>
        protected virtual Expression VisitMethodCall(MethodCallExpression expression, object memberValue = default(object))
		{
			return expression;
		}
		...
		/// <param name="expression">表达式</param>
		/// <returns>表达式</returns>
		protected virtual Expression VisitUnary(UnaryExpression expression, object memberValue = default(object))
        {
			this.Visit(expression.Operand, memberValue);
			return expression;
		}
