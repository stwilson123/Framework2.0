...
namespace DBORM
{
	...
	internal class UpdateBuilder<T> : ExpressionVisitor where T : new()
	{
        ...
        public UpdateBuilder(IDatabase db, List<object> args = null)
		{
        ...
        protected override Expression VisitMethodCall(MethodCallExpression expression, object memberValue = default(object))
		{
			switch(expression.Method.Name)
			{
				case "ToString":
					...
					break;
				default:
                    throw new NotImplementedException(string.Format("MethodCallExpression:{0} is not implemented", expression.Method.Name));
			}
