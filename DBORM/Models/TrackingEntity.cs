...
namespace DBORM
{
    ...
    public class TrackingEntity<T> where T : IPropertyChanged
	{
        
		private Parameters PARAMS;
        private Dictionary<string, Change> dicChange = new Dictionary<string,Change>();
		...
		public TrackingEntity(T original, Parameters param = null)
		{
            ...
            ((IPropertyChanged)TrackedEntity).PropertyChanged += PropertyChangedEventHandler;
		...
		public static List<Change> GetChanges(T entity, T refer, Parameters param = null)
		{
			...
			{
                if (param.IgnoreVirtual && (a.IsVirtual || (a.DataType.IsGenericType && a.DataType.GetGenericTypeDefinition() == typeof(List<>)))) continue;
        ...
        public List<Change> GetChanges()
        {
            return dicChange.Select(change => change.Value).ToList();
        }
        ...
        private void PropertyChangedEventHandler(object sender, PropertyChangedEventArgs e)
        {
            ...
            foreach (var a in als.Values)
            {
                if (PARAMS.IgnoreVirtual && (a.IsVirtual || (a.DataType.IsGenericType && a.DataType.GetGenericTypeDefinition() == typeof(List<>)))) continue;
                ...
                if (a.Name == e.PropertyName)
                {
                     ...
                     dicChange.Add(a.Name,new Change { Name = a.Name, NewValue = newValue });
                     break;
                }
