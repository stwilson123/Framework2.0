...
namespace DBEntityGenerate.PetaPoco.Interface
{
    public interface IQuery
    {
        ...
        ///     total number of records in the result set.
        /// </remarks>
        Page<T> Page<T, T1>(long page, long itemsPerPage, Sql sql);
        ...
        /// </remarks>
        /// 
        Page<T> Page<T, T1, T2>(long page, long itemsPerPage, Sql sql);
        ...
        /// </remarks>
        /// 
        Page<T> Page<T, T1, T2, T3>(long page, long itemsPerPage, Sql sql);
        ...
        /// </remarks>
        /// 
        Page<T> Page<T, T1, T2, T3, T4>(long page, long itemsPerPage, Sql sql);
        ...
        /// </remarks>
        /// 
        Page<T> Page<T, T1, T2, T3, T4, T5>(long page, long itemsPerPage, Sql sql);
