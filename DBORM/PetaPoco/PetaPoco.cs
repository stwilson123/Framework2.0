...
#pragma warning disable 1066,1570,1573,1591
    ...
    public partial class Database : IDatabase
    {
        ...
        public void AbortTransaction()
        {
            ...
            //transactionDepth shouldn't nagtive
        ...
        private void AddParam(IDbCommand cmd, object value, PropertyInfo pi)
        {
            ...
            else
            {
                ...
                else if (t == typeof(string))
                {
                    ...
                    if (p.GetType().Name == "OracleParameter")
                    {
                        var valueLength = (value as string).Length;
                        if (valueLength + 1 > 1000)
                            p.GetType().GetProperty("OracleDbType").SetValue(p, OracleDbType.NVarchar2, null);
                    }
        ...
        public Page<T> Page<T>(long page, long itemsPerPage, string sqlCount, object[] countArgs, string sqlPage, object[] pageArgs)
        {
            ...
            //TODO
            var totalItems = ExecuteScalar<long?>(sqlCount, countArgs);
        ...
        /// </remarks>
        public Page<T> Page<T, T1>(Func<T, T1, T> cb, long page, long itemsPerPage, Sql sql)
        {
            string sqlCount, sqlPage;
            object[] Arguments = sql.Arguments;
            BuildPageQueries<T>((page - 1) * itemsPerPage, itemsPerPage, sql.SQL, ref Arguments, out sqlCount, out sqlPage);
            return Page<T, T1>(cb,page, itemsPerPage, sqlCount, Arguments, sqlPage, Arguments);
        }
        /// <summary>
        ///     Retrieves a page of records	and the total number of available records
        /// </summary>
        ...
        ///     total number of records in the result set.
        /// </remarks>
        public Page<T> Page<T, T1, T2>(Func<T, T1, T2,T> cb, long page, long itemsPerPage, Sql sql)
        {
            string sqlCount, sqlPage;
            object[] Arguments = sql.Arguments;
            BuildPageQueries<T>((page - 1) * itemsPerPage, itemsPerPage, sql.SQL, ref Arguments, out sqlCount, out sqlPage);
            return Page<T, T1, T2>(cb,page, itemsPerPage, sqlCount, Arguments, sqlPage, Arguments);
        }
        ...
        ///     total number of records in the result set.
        /// </remarks>
        public Page<T> Page<T, T1, T2, T3>(Func<T, T1, T2,T3, T> cb, long page, long itemsPerPage, Sql sql)
        {
            string sqlCount, sqlPage;
            object[] Arguments = sql.Arguments;
            BuildPageQueries<T>((page - 1) * itemsPerPage, itemsPerPage, sql.SQL, ref Arguments, out sqlCount, out sqlPage);
            return Page<T, T1, T2, T3>(cb,page, itemsPerPage, sqlCount, Arguments, sqlPage, Arguments);
        }
        ...
        ///     total number of records in the result set.
        /// </remarks>
        public Page<T> Page<T, T1, T2, T3, T4>(Func<T, T1, T2, T3, T4, T> cb, long page, long itemsPerPage, Sql sql)
        {
            string sqlCount, sqlPage;
            object[] Arguments = sql.Arguments;
            BuildPageQueries<T>((page - 1) * itemsPerPage, itemsPerPage, sql.SQL, ref Arguments, out sqlCount, out sqlPage);
            return Page<T, T1, T2, T3,T4 > (cb, page, itemsPerPage, sqlCount, Arguments, sqlPage, Arguments);
        }
        ...
        ///     total number of records in the result set.
        /// </remarks>
        public Page<T> Page<T, T1, T2, T3, T4, T5>(Func<T, T1, T2, T3, T4, T5,T> cb, long page, long itemsPerPage, Sql sql)
        {
            string sqlCount, sqlPage;
            object[] Arguments = sql.Arguments;
            BuildPageQueries<T>((page - 1) * itemsPerPage, itemsPerPage, sql.SQL, ref Arguments, out sqlCount, out sqlPage);
            return Page<T, T1, T2, T3, T4, T5>(cb, page, itemsPerPage, sqlCount, Arguments, sqlPage, Arguments);
        }
        ...
        ///     total number of records in the result set.
        /// </remarks>
        public Page<T> Page<T, T1, T2, T3, T4, T5, T6>(Func<T, T1, T2, T3, T4, T5, T6, T> cb, long page, long itemsPerPage, Sql sql)
        {
            string sqlCount, sqlPage;
            object[] Arguments = sql.Arguments;
            BuildPageQueries<T>((page - 1) * itemsPerPage, itemsPerPage, sql.SQL, ref Arguments, out sqlCount, out sqlPage);
            return Page<T, T1, T2, T3, T4, T5, T6>(cb, page, itemsPerPage, sqlCount, Arguments, sqlPage, Arguments);
        }
        ...
        ///     total number of records in the result set.
        /// </remarks>
        public Page<T> Page<T, T1, T2, T3, T4, T5, T6, T7>(Func<T, T1, T2, T3, T4, T5, T6, T7,T> cb, long page, long itemsPerPage, Sql sql)
        {
            string sqlCount, sqlPage;
            object[] Arguments = sql.Arguments;
            BuildPageQueries<T>((page - 1) * itemsPerPage, itemsPerPage, sql.SQL, ref Arguments, out sqlCount, out sqlPage);
            return Page<T, T1, T2, T3, T4, T5, T6, T7>(cb, page, itemsPerPage, sqlCount, Arguments, sqlPage, Arguments);
        }
        ...
        ///     total number of records in the result set.
        /// </remarks>
        public Page<T> Page<T, T1, T2, T3, T4, T5, T6, T7, T8>(Func<T, T1, T2, T3, T4, T5, T6, T7, T8, T> cb, long page, long itemsPerPage, Sql sql)
        {
            string sqlCount, sqlPage;
            object[] Arguments = sql.Arguments;
            BuildPageQueries<T>((page - 1) * itemsPerPage, itemsPerPage, sql.SQL, ref Arguments, out sqlCount, out sqlPage);
            return Page<T, T1, T2, T3, T4, T5, T6, T7, T8>(cb, page, itemsPerPage, sqlCount, Arguments, sqlPage, Arguments);
        }
        ...
        ///     total number of records in the result set.
        /// </remarks>
        public Page<T> Page<T, T1, T2, T3, T4, T5, T6, T7, T8, T9>(Func<T, T1, T2, T3, T4, T5, T6, T7, T8, T9, T> cb, long page, long itemsPerPage, Sql sql)
        {
            string sqlCount, sqlPage;
            object[] Arguments = sql.Arguments;
            BuildPageQueries<T>((page - 1) * itemsPerPage, itemsPerPage, sql.SQL, ref Arguments, out sqlCount, out sqlPage);
            return Page<T, T1, T2, T3, T4, T5, T6, T7, T8,T9 > (cb, page, itemsPerPage, sqlCount, Arguments, sqlPage, Arguments);
        }
        ...
        ///     total number of records in the result set.
        /// </remarks>
        public Page<T> Page<T, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(Func<T, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T> cb, long page, long itemsPerPage, Sql sql)
        {
            string sqlCount, sqlPage;
            object[] Arguments = sql.Arguments;
            BuildPageQueries<T>((page - 1) * itemsPerPage, itemsPerPage, sql.SQL, ref Arguments, out sqlCount, out sqlPage);
            return Page<T, T1, T2, T3, T4, T5, T6, T7, T8, T9,T10>(cb, page, itemsPerPage, sqlCount, Arguments, sqlPage, Arguments);
        }


        #endregion

        public Page<T> Page<T, T1>(Func<T, T1, T> cb, long page, long itemsPerPage, string sqlCount, object[] countArgs, string sqlPage, object[] pageArgs)
        {
            var result = PageCount<T>(page, itemsPerPage, sqlCount, countArgs, sqlPage, pageArgs);

            // Get the records
            result.Items = Fetch<T, T1, T>(null, sqlPage, pageArgs);

            // Done
            return result;
        }

        public Page<T> Page<T, T1, T2>(Func<T, T1, T2,T> cb,long page, long itemsPerPage, string sqlCount, object[] countArgs, string sqlPage, object[] pageArgs)
        {
            var result = PageCount<T>(page, itemsPerPage, sqlCount, countArgs, sqlPage, pageArgs);

            // Get the records
            result.Items = Fetch<T, T1, T2, T>(null, sqlPage, pageArgs);

            // Done
            return result;
        }

        public Page<T> Page<T, T1, T2, T3>(Func<T, T1, T2,T3, T> cb, long page, long itemsPerPage, string sqlCount, object[] countArgs, string sqlPage, object[] pageArgs)
        {
            var result = PageCount<T>(page, itemsPerPage, sqlCount, countArgs, sqlPage, pageArgs);

            // Get the records
            result.Items = Fetch<T, T1, T2, T3, T>(null,sqlPage, pageArgs);

            // Done
            return result;
        }

        public Page<T> Page<T, T1, T2, T3, T4>(Func<T, T1, T2, T3, T4, T> cb, long page, long itemsPerPage, string sqlCount, object[] countArgs, string sqlPage, object[] pageArgs)
        {
            var result = PageCount<T>(page, itemsPerPage, sqlCount, countArgs, sqlPage, pageArgs);

            // Get the records
            result.Items = Query<T>(new Type[] { typeof(T), typeof(T1), typeof(T2),typeof(T3), typeof(T4) },null, sqlPage, pageArgs).ToList();

            // Done
            return result;
        }
        public Page<T> Page<T, T1, T2, T3, T4,T5>(Func<T, T1, T2, T3, T4, T5, T> cb, long page, long itemsPerPage, string sqlCount, object[] countArgs, string sqlPage, object[] pageArgs)
        {
            var result = PageCount<T>(page, itemsPerPage, sqlCount, countArgs, sqlPage, pageArgs);

            // Get the records
            result.Items = Query<T>(new Type[] { typeof(T), typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5) }, cb, sqlPage, pageArgs).ToList();

            // Done
            return result;
        }

        public Page<T> Page<T, T1, T2, T3, T4, T5,T6>(Func<T, T1, T2, T3, T4, T5, T6, T> cb, long page, long itemsPerPage, string sqlCount, object[] countArgs, string sqlPage, object[] pageArgs)
        {
            var result = PageCount<T>(page, itemsPerPage, sqlCount, countArgs, sqlPage, pageArgs);

            // Get the records
            result.Items = Query<T>(new Type[] { typeof(T), typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5),typeof(T6) }, null, sqlPage, pageArgs).ToList();

            // Done
            return result;
        }

        public Page<T> Page<T, T1, T2, T3, T4, T5, T6, T7>(Func<T, T1, T2, T3, T4, T5, T6, T7, T> cb, long page, long itemsPerPage, string sqlCount, object[] countArgs, string sqlPage, object[] pageArgs)
        {
            var result = PageCount<T>(page, itemsPerPage, sqlCount, countArgs, sqlPage, pageArgs);

            // Get the records
            result.Items = Query<T>(new Type[] { typeof(T), typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5), typeof(T6), typeof(T7) }, null, sqlPage, pageArgs).ToList();

            // Done
            return result;
        }

        public Page<T> Page<T, T1, T2, T3, T4, T5, T6, T7, T8>(Func<T, T1, T2, T3, T4, T5, T6, T7, T8, T> cb, long page, long itemsPerPage, string sqlCount, object[] countArgs, string sqlPage, object[] pageArgs)
        {
            var result = PageCount<T>(page, itemsPerPage, sqlCount, countArgs, sqlPage, pageArgs);

            // Get the records
            result.Items = Query<T>(new Type[] { typeof(T), typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5), typeof(T6), typeof(T7), typeof(T8) }, null, sqlPage, pageArgs).ToList();

            // Done
            return result;
        }

        public Page<T> Page<T, T1, T2, T3, T4, T5, T6, T7, T8, T9>(Func<T, T1, T2, T3, T4, T5, T6, T7, T8, T9, T> cb, long page, long itemsPerPage, string sqlCount, object[] countArgs, string sqlPage, object[] pageArgs)
        {
            var result = PageCount<T>(page, itemsPerPage, sqlCount, countArgs, sqlPage, pageArgs);

            // Get the records
            result.Items = Query<T>(new Type[] { typeof(T), typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5), typeof(T6), typeof(T7), typeof(T8), typeof(T9) }, null, sqlPage, pageArgs).ToList();

            // Done
            return result;
        }

        public Page<T> Page<T, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(Func<T, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T> cb, long page, long itemsPerPage, string sqlCount, object[] countArgs, string sqlPage, object[] pageArgs)
        {
            var result = PageCount<T>(page, itemsPerPage, sqlCount, countArgs, sqlPage, pageArgs);

            // Get the records
            result.Items = Query<T>(new Type[] { typeof(T), typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5), typeof(T6), typeof(T7), typeof(T8), typeof(T9) , typeof(T10) }, null, sqlPage, pageArgs).ToList();

            // Done
            return result;
        }
        public Page<T> PageCount<T>(long page, long itemsPerPage, string sqlCount, object[] countArgs, string sqlPage, object[] pageArgs)
        {
            // Save the one-time command time out and use it for both queries
            var saveTimeout = OneTimeCommandTimeout;
    ...
    public interface IQuery
    {
        ...
        ///     total number of records in the result set.
        /// </remarks>
        Page<T> Page<T, T1>(Func<T,T1,T> cb,long page, long itemsPerPage, Sql sql);
        ...
        /// </remarks>
        /// 
        Page<T> Page<T, T1, T2>(Func<T, T1, T2,T> cb, long page, long itemsPerPage, Sql sql);
        ...
        /// </remarks>
        /// 
        Page<T> Page<T, T1, T2, T3>(Func<T, T1, T2, T3,T> cb, long page, long itemsPerPage, Sql sql);
        ...
        /// </remarks>
        /// 
        Page<T> Page<T, T1, T2, T3, T4>(Func<T, T1, T2, T3, T4, T> cb, long page, long itemsPerPage, Sql sql);
        ...
        /// </remarks>
        /// 
        Page<T> Page<T, T1, T2, T3, T4, T5>(Func<T, T1, T2, T3, T4, T5, T> cb, long page, long itemsPerPage, Sql sql);
        ...
        /// </remarks>
        /// 
        Page<T> Page<T, T1, T2, T3, T4, T5, T6>(Func<T, T1, T2, T3, T4, T5, T6, T> cb, long page, long itemsPerPage, Sql sql);
        ...
        /// </remarks>
        /// 
        Page<T> Page<T, T1, T2, T3, T4, T5, T6, T7>(Func<T, T1, T2, T3, T4, T5, T6, T7, T> cb, long page, long itemsPerPage, Sql sql);
        ...
        /// </remarks>
        /// 
        Page<T> Page<T, T1, T2, T3, T4, T5, T6, T7, T8>(Func<T, T1, T2, T3, T4, T5, T6, T7, T8, T> cb, long page, long itemsPerPage, Sql sql);
        ...
        /// </remarks>
        /// 
        Page<T> Page<T, T1, T2, T3, T4, T5, T6, T7, T8, T9>(Func<T, T1, T2, T3, T4, T5, T6, T7, T8, T9, T> cb, long page, long itemsPerPage, Sql sql);
        ...
        /// </remarks>
        /// 
        Page<T> Page<T, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(Func<T, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T> cb, long page, long itemsPerPage, Sql sql);
        ...
        public static object GetAutoMapper(Type[] types)
        {
            ...
            return AutoMappers.Get(key, () =>
            {
                ...
                for (var i = 1; i < types.Length; i++)
                {
                    ...
                    if (!handled)
                        throw new InvalidOperationException(string.Format("Can't auto join {0},because can't find {0} parent model", types[i]));
                }
    ...
    public class PagingHelper : IPagingHelper
    {
        ...
        public bool SplitSQL(string sql, out SQLParts parts)
        {
            ...
            {
                var sqlColumn = m.Groups[1].ToString().Trim();
                if (!sqlColumn.Contains(','))
                    ...
                    parts.SqlCount = sql.Substring(0, g.Index) + "COUNT(*) FROM (SELECT " + sqlColumn + sql.Substring(g.Index + g.Length) + ") ";
            }
            else if (parts.SqlSelectRemoved.IndexOf("Group by",StringComparison.OrdinalIgnoreCase) > -1)
            {
                var sqlColumn = m.Groups[1].ToString().Trim();
                parts.SqlCount = sql.Substring(0, g.Index) + "COUNT(*) FROM (SELECT " + sqlColumn +" "+ sql.Substring(g.Index + g.Length) + ")  CountTable";
            }
            else
