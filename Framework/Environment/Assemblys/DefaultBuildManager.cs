...
namespace Framework.Environment.Assemblys
{
    public class DefaultBuildManager : IBuildManager {
        ...
        public IEnumerable<System.Reflection.Assembly> GetReferencedAssemblies() {
            return BuildManager.GetReferencedAssemblies().OfType<System.Reflection.Assembly>();
        }
        ...
        public System.Reflection.Assembly GetCompiledAssembly(string virtualPath) {
            try {
