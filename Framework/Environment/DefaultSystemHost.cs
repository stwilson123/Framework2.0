...
namespace Framework.Environment
{
    ...
    public class DefaultSystemHost : ISystemHost, IShellSettingsManagerEventHandler, IShellDescriptorManagerEventHandler {
        ...
        void ISystemHost.Initialize() {
            Logger.Information("Initializing");
            BuildCurrent();
            Logger.Information("Initialized");
        }

        void ISystemHost.ReloadExtensions() {
            DisposeShellContext();
        }

        void ISystemHost.BeginRequest() {
            Logger.Debug("BeginRequest");
            BeginRequest();
        }

        void ISystemHost.EndRequest() {
            Logger.Debug("EndRequest");
            EndRequest();
        }

        IWorkContextScope ISystemHost.CreateStandaloneEnvironment(ShellSettings shellSettings) {
