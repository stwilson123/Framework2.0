...
{
   public class DefaultSystemHostContainer : ISystemHostContainer, IDependencyResolver {
        private readonly IContainer _container;


        public DefaultSystemHostContainer(IContainer container) {
        ...
        TService ISystemHostContainer.Resolve<TService>() {
