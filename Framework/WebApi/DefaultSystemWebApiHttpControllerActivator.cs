...
{
    public class DefaultSystemWebApiHttpControllerActivator : IHttpControllerActivator {
        private readonly HttpConfiguration _configuration;

        public DefaultSystemWebApiHttpControllerActivator(HttpConfiguration configuration)
            : base() {
