...
{
   public class DefaultSystemWebApiHttpControllerSelector : DefaultHttpControllerSelector, IHttpControllerSelector {
        private readonly HttpConfiguration _configuration;

        public DefaultSystemWebApiHttpControllerSelector(HttpConfiguration configuration) : base(configuration) {
