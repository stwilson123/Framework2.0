    ...
    public class Starter<T> where T : class
    {
        ...
        public void OnBeginRequest(HttpApplication application)
        {
            ...
            if (_error != null)
            {
                ...
                if (restartInitialization) LaunchStartupThread(application);
            }
            ...
            if (_initializationResult != null) _beginRequest(application, _initializationResult);
        }

        public void OnEndRequest(HttpApplication application)
        {
            // Only notify if the initialization has successfully completed
            if (_initializationResult != null) _endRequest(application, _initializationResult);
        }
        ...
        private void LaunchStartupThread(HttpApplication application)
        {
            ...
            StartUpHttpModule.SignalWarmupStart();
            ...
            ThreadPool.QueueUserWorkItem(
                state =>
                {
                    ...
                    finally
                    {
                        ...
                        StartUpHttpModule.SignalWarmupDone();
                    }
                });
        }
    }
